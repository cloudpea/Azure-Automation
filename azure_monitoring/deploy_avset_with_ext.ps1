...
Write-Output ""
Write-Output "Azure AV Set with Extension Deployment"
...
New-AzureRmResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateFile $Path+'\AVSetWithExtension.json' `
-TemplateParameterFile $Path+'\AVSetWithExtension.parameters.json'
